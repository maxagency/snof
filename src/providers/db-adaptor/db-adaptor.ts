...
export class DBAdaptorProvider {
  ...
  constructor(public platform: Platform,
    ...
    this.index = {
      //'all-object': {},          // all
      //'sort-object-lastModifiedDate': {},     // sort index
      ...
      'keyword-session_user': {},      // keyword index
      'keyword-user_drill': {}
  ...
  updateIndexes() {
    ...
    return new Promise(resolve => {
      ...
      ps.push(this.updateIndexesForObjectType('user_drill'));
      ps.push(this.updateIndexesForObjectType('session_user'));
